...
import static org.nutz.repo.org.objectweb.asm.Opcodes.AASTORE;
import static org.nutz.repo.org.objectweb.asm.Opcodes.ACC_PUBLIC;
import static org.nutz.repo.org.objectweb.asm.Opcodes.ACONST_NULL;
import static org.nutz.repo.org.objectweb.asm.Opcodes.ALOAD;
import static org.nutz.repo.org.objectweb.asm.Opcodes.ANEWARRAY;
import static org.nutz.repo.org.objectweb.asm.Opcodes.ARETURN;
import static org.nutz.repo.org.objectweb.asm.Opcodes.ASTORE;
import static org.nutz.repo.org.objectweb.asm.Opcodes.CHECKCAST;
import static org.nutz.repo.org.objectweb.asm.Opcodes.DUP;
import static org.nutz.repo.org.objectweb.asm.Opcodes.GETFIELD;
import static org.nutz.repo.org.objectweb.asm.Opcodes.GOTO;
import static org.nutz.repo.org.objectweb.asm.Opcodes.ICONST_0;
import static org.nutz.repo.org.objectweb.asm.Opcodes.ICONST_1;
import static org.nutz.repo.org.objectweb.asm.Opcodes.IFNE;
import static org.nutz.repo.org.objectweb.asm.Opcodes.IFNONNULL;
import static org.nutz.repo.org.objectweb.asm.Opcodes.IFNULL;
import static org.nutz.repo.org.objectweb.asm.Opcodes.ILOAD;
import static org.nutz.repo.org.objectweb.asm.Opcodes.INVOKEINTERFACE;
import static org.nutz.repo.org.objectweb.asm.Opcodes.INVOKESPECIAL;
import static org.nutz.repo.org.objectweb.asm.Opcodes.INVOKESTATIC;
import static org.nutz.repo.org.objectweb.asm.Opcodes.INVOKEVIRTUAL;
import static org.nutz.repo.org.objectweb.asm.Opcodes.LLOAD;
import static org.nutz.repo.org.objectweb.asm.Opcodes.NEW;
import static org.nutz.repo.org.objectweb.asm.Opcodes.POP;
