...
public class VelocityTemplateView extends AbstractPathView {

	private static final Logger LOG = LoggerFactory.getLogger(VelocityTemplateView.class);
	...
	public VelocityTemplateView(String dest) {
		super(dest);
	}
